...
public class ExerciseController {
    ...
    public @ResponseBody ExerciseDTO createExercise(@RequestParam("file") MultipartFile multipartFile, @RequestParam("labels") List<String> labels, @RequestParam("year") Integer year) throws IOException {
        return exerciseService.createExercise(multipartFile, labels, year);
    }
