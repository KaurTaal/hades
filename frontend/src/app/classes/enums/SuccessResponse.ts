export class SuccessResponse {
  static readonly MANUAL_DELETE_SUCCESS = "Juhend kustutatud!";
  static readonly EXERCISE_DELETE_SUCCESS = "Ülesanne kustutatud!";
  static readonly MANUAL_SAVE_SUCCESS = "Juhend salvestatud!";
